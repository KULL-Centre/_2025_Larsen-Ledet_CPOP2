...
* **nanoDSF_rep[1-3]** - Raw nanoDSF data.
...
*Excel files*
* **SupplementaryFile.xlsx** - A single combined Excel file with CPOP scores and standard deviations for DHFR indel, synonymous and nonsense variants in the WT strain, ubr1 knockout strain, and san1 knockout strain, all primer sequences, and raw aggregate, nanoDSF, and Western blotting data.
